...
<body>
        ...
        <div class="box form-box">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (mysqli_num_rows($fullname_query) > 0) {
                    ...
                    if ($insert_result) {
                        $popupSuccessMessage = "Congratulations! You are now registered to the Barangay Talon 3 Healthcare Center!";
                    } else {
                        $popupSuccessMessage = "Error occurred while registering.";
                    }
                }
            }
            ?>
            ...
            <form action="" method="post">
                ...
                <div class="field-input" style="padding-top:20px">
                    ...
                    <input type="date" name="dateOfBirth" id="dateOfBirth" required max="2023-12-31">
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            dateInput.addEventListener('input', function () {
                ...
                // Check if the entered year is too large
                if (enteredDate.getFullYear() > new Date().getFullYear()) {
                    // If so, set the date to the current year
    ...
    <div class="popup-container" id="popupSuccess" style="<?php echo !empty($popupSuccessMessage) ? 'display:block;' : 'display:none;'; ?>">
        <div class='message'>
            <p><?php echo $popupSuccessMessage; ?></p>
            <a href="index.php"><button class='failed-btn'>Back to Home</button></a>
            <a href="appointment.php"><button class='failed-btn' style="margin-top: -5px; background-color:#0B666A">Book an Appointment</button></a>
        </div>
    </div>
